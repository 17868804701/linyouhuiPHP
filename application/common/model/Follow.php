...
class Follow extends Model
{
    ...
    public function follow($uid)
    {
        ...
        D('Common/Message')->sendMessage($uid, lang('_FANS_NUMBER_INCREASED_'), $user['nickname'] . lang('_CONCERN_YOU_WITH_PERIOD_'), 'Ucenter/Index/index', array('uid' => is_login()),-1,'Ucenter');
    ...
    public function unfollow($uid)
    {
        ...
        D('Message')->sendMessage($uid, lang('_NUMBER_OF_FANS_'), $user['nickname'] . lang('_CANCEL_YOUR_ATTENTION_WITH_PERIOD_'), 'Ucenter/Index/index', array('uid' => is_login()),-1,'Ucenter');
    ...
    public function addFollow($who_follow, $follow_who, $invite = 0)
    {
        ...
        $arr[]='star';
        foreach ($arr as $a){
            cache($a.'_follow_cache_'. $follow['who_follow'],null);
        }unset($a);
        ...
        // D('Common/Message')->sendMessage($follow_who, lang('_FANS_NUMBER_INCREASED_'), $content,
        // 'Ucenter/Index/index', array('uid' => $who_follow), $who_follow,'Ucenter');
