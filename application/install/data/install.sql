...
CREATE TABLE wei.uctoo_delivery
(
  id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  user_id INT COMMENT '用户',
  shop_id INT COMMENT '店铺',
  title VARCHAR(20),
  price DECIMAL(10,2),
...
ALTER TABLE wei.uctoo_delivery COMMENT = '运费模板';
...
(10, 'temp', '测试插件', '测试插件', 1, '{\"random\":\"1\"}', 'UCToo', '0.1', '1463128688', '0'),
...
(2008, 'admin', '1', 'mpbase/Custommenu/operate', '自定义菜单操作', '1', ''),
(2009, 'admin', '1', 'mpbase/Custommenu/index', '自定义菜单管理', '1', ''),
(2010, 'admin', '1', 'mpbase/Custommenu/add', '编辑自定义菜单', '1', ''),
...
(2, 0, '内容', 'shop/index/index', 2, 0, 0, 1, 0, '', '', '', 'shopping-cart', '', '');
...
(73, 'temphook', '测试钩子', '1', 1442221555, 'temp'),
...
(29, 'UCToo官方订制门店', '<p><span style="color: rgb(53, 53, 53); font-family: &39;Microsoft YaHei&39;; font-size: 13px; line-height: 20px; background-color: rgb(255, 255, 255);">深圳优创智投科技有限公司英文全称Universal Convergence Technology Co.Ltd。</span></p>', 7, 3, 14, 1, 0, 1430704938, 1452479973, 1, 'http://www.uctoo.cn/index.php?s=/sappstore/index/index.html'),
...
--
 ...
 (1, '网站首页', 0, 1, 'admin/Index/index', 0, '', '', 0, 'home', ''),

 (233, '仪表盘', 1, 0, 'admin/Index/index', 0, '', '系统', 0, '', ''),
 (234, '数据统计', 1, 1, 'admin/Index/stats', 0, '', '系统', 0, '', ''),
 (236, '基础配置', 1, 0, 'admin/UserConfig/index', 0, '', '设置', 0, '', 'home'),
 (237, '后台菜单管理', 1, 6, 'admin/Menu/index', 0, '', '设置', 0, '', ''),
 (238, '备份数据库', 1, 8, 'admin/Database/index?type=export', 0, '', '数据备份', 0, '', ''),
 (239, '还原数据库', 1, 9, 'admin/Database/index?type=import', 0, '', '数据备份', 0, '', ''),
 (2, '会员中心', 0, 2, 'ucuser/ucuser/index', 0, '', '', 0, 'user', ''),
 (35, '会员信息', 2, 0, 'ucuser/Ucuser/index', 0, '', '用户管理', 0, '', ''),
 (3, '群管理员', 2, 2, 'ucuser/Ucuser/admin', 0, '', '用户管理', 0, '', ''),
 (5, '权限组管理', 2, 5, 'admin/AuthManager/index', 0, '', '权限管理', 0, '', ''),
 (6, '行为日志', 2, 6, 'admin/Action/actionlog', 0, '', '权限管理', 0, '', ''),
 (7, '行为限制', 2, 4, 'admin/Action/actionLimit', 0, '', '权限管理', 0, '', ''),
 (8, '修改密码', 2, 3, 'admin/User/updatePassword', 1, '', '', 0, '', ''),
 (9, '修改昵称', 2, 4, 'admin/User/updateNickname', 1, '', '', 0, '', ''),
 (20, '重置用户密码', 3, 0, 'admin/User/initpass', 1, '', '', 0, '', ''),
 (30, '微信管理', 0, 0, 'mpbase/Mpbase/index', 0, '', '', 0, 'mpbase', ''),
 (31, '公众号管理', 30, 0, 'mpbase/Mpbase/index', 0, '', '公众号', 0, '', ''),
 (32, '自定义菜单', 30, 2, 'mpbase/Custommenu/index', 0, '', '公众号', 0, '', ''),
 (33, '自动回复管理', 30, 4, 'mpbase/Mpbase/replay_messages', 0, '', '公众号', 0, '', ''),
 (34, '模板消息', 30, 10, 'admin/Tplmsg/index', 0, '', '公众号', 0, '', ''),
 (50, '商城管理', 0, 0, 'shop/Shop/shop', 0, '', '', 0, '', 'Shop'),
 (62, '社群商店', 50, 0, 'shop/shop/shop', 0, '', '群组管理', 0, '', 'Shop'),
 (64, '客服配置', 50, 0, 'shop/shop/contact', 0, '', '群组管理', 0, '', 'Shop'),
 (51, '商品列表', 50, 0, 'shop/shop/product', 0, '', '商品管理', 0, '', 'Shop'),
 (52, '商品分类', 50, 0, 'shop/shop/product_cats', 0, '', '商品管理', 0, '', 'Shop'),
 (53, '商品评论', 50, 0, 'shop/shop/product_comment', 0, '', '商品管理', 0, '', 'Shop'),
 (54, '订单管理', 50, 0, 'shop/shop/order', 0, '', '订单管理', 0, '', 'Shop'),
 (59, '运费模板', 50, 0, 'shop/shop/delivery', 0, '', '商城基本设置', 0, '', 'Shop'),
 (60, '商城幻灯片', 50, 0, 'shop/shop/slides', 0, '', '商城基本设置', 0, '', 'Shop');
...
(1, 'admin', '网站主页', '1.0.0', 0, 1, '首页模块，主要用于展示网站内容', 'UCT', 'http://www.uctoo.com', 'admin/index/index', 1, 0, 'home', 1, 'admin/index/index',0,''),
(2, 'ucenter', '会员中心', '1.0.0', 0, 1, '用户中心模块，系统核心模块', 'UCT', 'http://www.uctoo.com', 'ucenter/index/index', 1, 0, 'user', 0, 'ucuser/Ucuser/index',0,''),
(3, 'mpbase', '微信管理', '1.0.0', 0, 1, '基础设置模块，用于设置公众平台基础信息', 'UCToo', 'http://www.uctoo.com', 'mpbase/index/index', 1, 0, 'wechat', 0, 'mpbase/Mpbase/index',0,''),
(5, 'shop', '商城管理', '1.0.2', 0, 1, '公司模块', 'UCToo', '', 'shop/shop/product', 1, 0, 'shopping-cart', 1,
 'shop/Shop/product',0,'');
...
CREATE TABLE `uctoo_shop_order` (
  ...
  `twon` VARCHAR(10) NOT NULL DEFAULT '' COMMENT '乡镇',
  ...
  `goods_sum` int NOT NULL DEFAULT 0 COMMENT '商品总数',
  `goods_spec` VARCHAR(100) DEFAULT '' NOT NULL COMMENT '规格',
...
CREATE TABLE `uctoo_order_goods` (
  ...
  KEY `order_id` (`order_id`),
  KEY `goods_id` (`goods_id`)
)  AUTO_INCREMENT=1759 DEFAULT CHARSET=utf8;
...
CREATE TABLE `uctoo_shop`(
  ...
  `shop_type` char(50) null,
  `image` INT,
  `shop_goods` int DEFAULT 0 comment '商品数量',
  `shop_member` int DEFAULT 0 comment '商城会员',
  `shop_content` varchar(255) DEFAULT '' comment '商城介绍',
  `create_time` int(10) DEFAULT 0,
  `update_time` int(10) DEFAULT 0,
  `sort` int DEFAULT 1 comment '排名',
  `status` INT default 0 comment '商店状态',
  `shop_owner` VARCHAR(50) DEFAULT '' comment '管理者',
  `shop_owner_id` int DEFAULT 0 comment '管理者'
...
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='关于我们';
...
CREATE TABLE `uctoo_shop_goods` (
  ...
  `shop_id` int NULL DEFAULT 1 comment '所属商店',
  `shop_name` varchar(100) NULL comment '所属商店',
  `cat_id` int(11) UNSIGNED DEFAULT '0' COMMENT '分类id',
  ...
  `shipping_area_ids` varchar(255) DEFAULT '' COMMENT '配送物流shipping_area_id,以逗号分隔'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `uctoo_spec_goods_price` (
  ...
  `name1` char(55)  NULL COMMENT '规格键名中文',
  `price1` int DEFAULT NULL COMMENT '价格',
  `store1` int(11) unsigned DEFAULT '10' COMMENT '库存数量',
  `name2` CHAR(55) NULL,
  `price2` int NULL,
  `store2` INT NULL,
  `name3` CHAR(55) NULL,
...
CREATE TABLE `uctoo_address` (
  ...
  `default` int DEFAULT 0 COMMENT '默认地址',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
...
CREATE TABLE IF NOT EXISTS `uctoo_ucenter_member` (
  ...
  `group` tinyint(4)  COMMENT '所属群组',
  `province` char(64)  COMMENT '省份',
  `city` char(64)  COMMENT '城市',
  `district` char(64)  COMMENT '区域',
